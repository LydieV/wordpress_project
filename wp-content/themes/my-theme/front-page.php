<?php get_header(); ?>
    ...
    <section class="section-5">
        ...
        <div class="infopratique_fond" style="background-image: url('<?php echo $background_img_infos['url']?>')">
            <div class="cote_vert">
                <div class="contenu_carte carteafter">
                   <svg xmlns="http://www.w3.org/2000/svg" width="56" height="75" viewBox="0 0 56 75" class="svg_carte">
                ...
                <div class="contenu_carte carteafter">
                    <svg xmlns="http://www.w3.org/2000/svg" width="62" height="62" viewBox="0 0 62 62" class="svg_carte">
                ...
                <div class="contenu_carte">
                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="61" viewBox="0 0 31 61" class="svg_carte">
