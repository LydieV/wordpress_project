...
<!-- VOTRE CODE HTML COMMENCE ICI -->
    ...
    <section class="section-4">
        <p class="section-title1"> Les orateurs</p>
    ...
    <section class="section-5">
        <p class="section-title1" > Informations pratiques</p>
            ...
            <div class="cote_vert">
                <div class="contenu_carte">
                   <svg xmlns="http://www.w3.org/2000/svg" width="56" height="75" viewBox="0 0 56 75">
                    ...
                    <p> Square Brussels Mont de Arts 1000 Bruxelles Belgique</p>
                </div>
                <div class="contenu_carte">
    ...
    <section class="section-6">
        <p class="section-title1"> Vidéos</p>
        <div class="section-6_contenu">
            <div>
                ...
                <div>
                    <div class="rubrique">
                        <img src="assets/img/video.jpg"/>
                        <div>
                            <p> Construction de la valeur des légumineuses</p>
                    ...
                    <div class="rubrique">
                        <img src="assets/img/video.jpg"/>
                        <div>
                            <p> Vers une éducation agri-alimentaire</p>
                            <p> Julie Le Gall</p>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="rubrique">
                    <img src="assets/img/video.jpg"/>
                    <div>
                        <p> L'agriculture urbaine, vitrine de la modernité</p>
                ...
                <div class="rubrique">
                    <img src="assets/img/video.jpg"/>
                    <div>
                        <p> Réinventer le lien entre citadins et agriculteurs </p>
                        <p> Nicolas Bricas </p>
                    </div>
                </div>
            </div>
    ...
    <section class="section-7">
        <p class="section-title1"> Actus</p>
         <div class="actu">
        <?php
